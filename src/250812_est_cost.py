...
if __name__ == '__main__':
    ...
    for kw in kws:
        ...
        fig_path = f'../figs/kw_{kw}/250812_lineplot_monthly_cost_kw_{kw}.png'
        monthly_costs = {}
        ...
        for s in scenarios:
            ...
            plt.savefig(f'../figs/kw_{kw}/250812_lineplot_pv_{s}.png')
    ...
    costs.to_csv('../output/250812_all_costs.csv')
    plt.show()