...
# Constants
IMPORT_PRICE = 0.30  # $ per kWh for buying
...
def plot_metrics(df: pd.DataFrame, scenario: int):
    """
    ...
    plt.ylabel('Value')
    plt.title(f'Scenario {scenario}: Metrics Over Time')
    plt.tight_layout()


if __name__ == '__main__':
    sell_price_file = '../input/250810 PGE Comp.csv'
    base_dir = '../output/kw_4.5/'
    fig_path = '../figs/kw_4.5/250810_lineplot_monthly_cost_kw_4_5.png'
    ...
    plt.title('Monthly Net Cost Comparison')
    plt.legend()
    plt.tight_layout()
    # Save figure
