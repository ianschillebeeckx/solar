...
if __name__ == '__main__':
    ...
    for kw in [6.4]: #[5.5, 6.4, 6.9, 7.5]:
        ...
        generations = [30] #[0, 10, 20, 30, 40, 50, 60, 70]

        # File definitions
        usage_file = '../output/251107_2025_adjusted_kWh.csv'

        # Batch simulate and save
        for i in generations:
            gen_file = generation_dir / f'pvwatts_hourly_{i}.csv'
            out_file = output_dir / f'251107_merged_battery_2025_onward_{i}.csv'
            ...
            fig_path = figs_dir / f'251107_lineplot_{short_desc}.png'
