...
if __name__ == "__main__":
    ...
    RAW_CSV = Path("../output/pge_usage_2025_projected.csv")
    OUT_CSV = Path("../output/250902_2025_adjusted_kWh.csv")
    PLOT_PNG = Path("../figs/250902_original_vs_adjusted.png")
    PLOT_PNG_HOD = Path("../figs/250902_hour_of_day_profiles.png")
