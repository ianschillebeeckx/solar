#!/usr/bin/env python3
"""
Master driver for the 260204 analysis pipeline.

Uses full year 2025 data (pge_usage_2025-01-01_to_2025-12-31.csv).
"""
...
SCRIPTS = [
    ("Interpolate 2025 usage", "260204_interpolate_2025_usage.py", {"MPLBACKEND": "Agg"}),
    ("Therm → kWh adjustment", "260204_therm2kWh.py", None),
    ("Battery simulations", "260204_sim_batteries.py", None),
    ("Cost estimation", "260204_est_cost.py", None),
    ("Payback visualization", "260204_payback.py", {"MPLBACKEND": "Agg"}),
]
